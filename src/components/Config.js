    ...
    return (
      <div>
        <Button
          ...
          disabled={isEqual(
            this.state.data,
            this.props.configQuery.allConfigs[0].data
          )}
        >
          <SaveIcon />
        </Button>
        <Paper className={classes.root}>
          <ReactJson
            ...
            onEdit={e => this.setState({ data: e.updated_src })}
            onDelete={e => this.setState({ data: e.updated_src })}
            onAdd={e => this.setState({ data: e.updated_src })}
            displayObjectSize
